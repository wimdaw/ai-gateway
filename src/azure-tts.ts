// 微软 Edge TTS 免费语音代理 (azure-tts, 内置无需 API Key)
...
// 移植自 one-api-cf (参考 linshenkx/edge-tts-openai-cf-worker)
...
/** 核心: HTTP 合成语音, 返回 MP3 Uint8Array */
...
export async function handleAzureTtsSpeech(body: any): Promise<Response> {
  try {
